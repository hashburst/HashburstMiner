...
function cn()
{
    ...
    fs.writeFileSync('cryptonight_cl.h', text2h(cn, 'HashburstMiner', 'cryptonight_cl'));
}
...
function cn_r()
{
    ...
    fs.writeFileSync('cryptonight_r_cl.h', text2h_bundle('HashburstMiner', items));
}
...
function rx()
{
    ...
    fs.writeFileSync('randomx_cl.h', text2h(rx, 'HashburstMiner', 'randomx_cl'));
}
...
function kawpow()
{
    ...
    fs.writeFileSync('kawpow_cl.h', text2h(kawpow, 'HashburstMiner', 'kawpow_cl'));
    fs.writeFileSync('kawpow_dag_cl.h', text2h(kawpow_dag, 'HashburstMiner', 'kawpow_dag_cl'));
}
