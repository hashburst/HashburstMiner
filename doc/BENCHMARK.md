...
You can run with HashburstMiner with the following commands:
```
HashburstMiner --bench=1M
HashburstMiner --bench=10M
HashburstMiner --bench=1M -a rx/wow
HashburstMiner --bench=10M -a rx/wow
```
...
```
HashburstMiner --stress
HashburstMiner --stress -a rx/wow
```
