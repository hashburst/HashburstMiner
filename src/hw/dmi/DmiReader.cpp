...
rapidjson::Value HashburstMiner::DmiReader::toJSON(rapidjson::Document &doc) const
{
    rapidjson::Value obj;
    toJSON(obj, doc);
...
void HashburstMiner::DmiReader::toJSON(rapidjson::Value &out, rapidjson::Document &doc) const
{
...
bool HashburstMiner::DmiReader::decode(uint8_t *buf, const Cleanup &cleanup)
{
...
bool HashburstMiner::DmiReader::decode(uint8_t *buf)
{
    if (!buf) {
        return false;
    }
