...
const char *HashburstMiner::Msr::tag()
{
    return kTag;
}
...
std::shared_ptr<HashburstMiner::Msr> HashburstMiner::Msr::get()
{
...
bool HashburstMiner::Msr::write(uint32_t reg, uint64_t value, int32_t cpu, uint64_t mask, bool verbose)
{
...
HashburstMiner::MsrItem HashburstMiner::Msr::read(uint32_t reg, int32_t cpu, bool verbose) const
{
    uint64_t value = 0;
