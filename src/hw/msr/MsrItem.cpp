...
HashburstMiner::MsrItem::MsrItem(const rapidjson::Value &value)
{
    if (!value.IsString()) {
        return;
    }
...
rapidjson::Value HashburstMiner::MsrItem::toJSON(rapidjson::Document &doc) const
{
    return toString().toJSON(doc);
}


HashburstMiner::String HashburstMiner::MsrItem::toString() const
{
