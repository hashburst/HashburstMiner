 ...
 * Copyright (c) 2016-2022 HashburstMiner       <https://github.com/hashburst/HashburstMiner>, <pegoraro.gabriele@gmail.com>
 *
...
#ifndef HashburstMiner_DONATE_H
#define HashburstMiner_DONATE_H


/*
 * Dev donation.
 *
 * Percentage of your hashing power that you want to donate to the developer can be 0% but supports HashburstMiner Development.
 *
