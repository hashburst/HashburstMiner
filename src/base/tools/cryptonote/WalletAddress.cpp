...
bool HashburstMiner::WalletAddress::decode(const char *address, size_t size)
{
    uint64_t tf_tag = 0;
...
bool HashburstMiner::WalletAddress::decode(const rapidjson::Value &address)
{
    return address.IsString() && decode(address.GetString(), address.GetStringLength());
}


const char *HashburstMiner::WalletAddress::netName() const
{
...
const char *HashburstMiner::WalletAddress::typeName() const
{
...
rapidjson::Value HashburstMiner::WalletAddress::toJSON(rapidjson::Document &doc) const
{
...
rapidjson::Value HashburstMiner::WalletAddress::toAPI(rapidjson::Document &doc) const
{
    using namespace rapidjson;
...
const HashburstMiner::WalletAddress::TagInfo &HashburstMiner::WalletAddress::tagInfo(uint64_t tag)
{
