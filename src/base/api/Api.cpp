...
HashburstMiner::Api::Api(Base *base) :
    m_base(base),
...
void HashburstMiner::Api::request(const HttpData &req)
{
...
void HashburstMiner::Api::onConfigChanged(Config *config, Config *previousConfig)
{
...
void HashburstMiner::Api::exec(IApiRequest &request)
{
    using namespace rapidjson;
...
void HashburstMiner::Api::genId(const String &id)
{
...
void HashburstMiner::Api::genWorkerId(const String &id)
{
