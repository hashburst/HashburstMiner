...
HashburstMiner::Httpd::Httpd(Base *base) :
    m_base(base)
{
...
HashburstMiner::Httpd::~Httpd() = default;


bool HashburstMiner::Httpd::start()
{
...
void HashburstMiner::Httpd::stop()
{
    delete m_server;
    delete m_http;
...
void HashburstMiner::Httpd::onConfigChanged(Config *config, Config *previousConfig)
{
...
void HashburstMiner::Httpd::onHttpData(const HttpData &data)
{
...
int HashburstMiner::Httpd::auth(const HttpData &req) const
{
