...
HashburstMiner::HttpApiRequest::HttpApiRequest(const HttpData &req, bool restricted) :
...
bool HashburstMiner::HttpApiRequest::accept()
{
...
const rapidjson::Value &HashburstMiner::HttpApiRequest::json() const
{
    if (type() == REQ_JSON_RPC) {
...
HashburstMiner::IApiRequest::Method HashburstMiner::HttpApiRequest::method() const
{
    return static_cast<IApiRequest::Method>(m_req.method);
}


void HashburstMiner::HttpApiRequest::done(int status)
{
...
void HashburstMiner::HttpApiRequest::setRpcError(int code, const char *message)
{
    using namespace rapidjson;
    auto &allocator = doc().GetAllocator();
...
void HashburstMiner::HttpApiRequest::setRpcResult(rapidjson::Value &result)
{
    rpcDone(kResult, result);
}


void HashburstMiner::HttpApiRequest::rpcDone(const char *key, rapidjson::Value &value)
{
    ApiRequest::done(0);
