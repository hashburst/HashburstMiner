...
#ifndef HashburstMiner_APIREQUEST_H
#define HashburstMiner_APIREQUEST_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(ApiRequest)
...
#endif // HashburstMiner_APIREQUEST_H
