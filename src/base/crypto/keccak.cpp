...
void HashburstMiner::keccakf(uint64_t st[25], int rounds)
{
...
void HashburstMiner::keccak(const uint8_t *in, int inlen, uint8_t *md, int mdlen)
{
    state_t st;
    ...
    for ( ; inlen >= rsiz; inlen -= rsiz, in += rsiz) {
        ...
        HashburstMiner::keccakf(st, KECCAK_ROUNDS);
    }
