...
HashburstMiner::Coin::Coin(const rapidjson::Value &value)
{
    if (value.IsString()) {
...
HashburstMiner::Algorithm HashburstMiner::Coin::algorithm(uint8_t) const
{
    return coinInfo[m_id].algorithm;
}


const char *HashburstMiner::Coin::code() const
{
    return coinInfo[m_id].code;
}


const char *HashburstMiner::Coin::name() const
{
    return coinInfo[m_id].name;
}


rapidjson::Value HashburstMiner::Coin::toJSON() const
{
...
uint64_t HashburstMiner::Coin::target(uint8_t) const
{
    return coinInfo[m_id].target;
}


uint64_t HashburstMiner::Coin::units() const
{
    return coinInfo[m_id].units;
}


HashburstMiner::Coin::Id HashburstMiner::Coin::parse(const char *name)
{
...
const char *HashburstMiner::Coin::tag(Id id)
{
