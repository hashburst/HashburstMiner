...
#ifndef HashburstMiner_LOG_H
#define HashburstMiner_LOG_H
...
#define LOG_EMERG(x, ...)   HashburstMiner::Log::print(HashburstMiner::Log::EMERG,   x, ##__VA_ARGS__)
#define LOG_ALERT(x, ...)   HashburstMiner::Log::print(HashburstMiner::Log::ALERT,   x, ##__VA_ARGS__)
#define LOG_CRIT(x, ...)    HashburstMiner::Log::print(HashburstMiner::Log::CRIT,    x, ##__VA_ARGS__)
#define LOG_ERR(x, ...)     HashburstMiner::Log::print(HashburstMiner::Log::ERR,     x, ##__VA_ARGS__)
#define LOG_WARN(x, ...)    HashburstMiner::Log::print(HashburstMiner::Log::WARNING, x, ##__VA_ARGS__)
#define LOG_NOTICE(x, ...)  HashburstMiner::Log::print(HashburstMiner::Log::NOTICE,  x, ##__VA_ARGS__)
#define LOG_INFO(x, ...)    HashburstMiner::Log::print(HashburstMiner::Log::INFO,    x, ##__VA_ARGS__)
#define LOG_VERBOSE(x, ...) if (HashburstMiner::Log::verbose() > 0) { HashburstMiner::Log::print(HashburstMiner::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V1(x, ...)      if (HashburstMiner::Log::verbose() > 0) { HashburstMiner::Log::print(HashburstMiner::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V2(x, ...)      if (HashburstMiner::Log::verbose() > 1) { HashburstMiner::Log::print(HashburstMiner::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V3(x, ...)      if (HashburstMiner::Log::verbose() > 2) { HashburstMiner::Log::print(HashburstMiner::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V4(x, ...)      if (HashburstMiner::Log::verbose() > 3) { HashburstMiner::Log::print(HashburstMiner::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V5(x, ...)      if (HashburstMiner::Log::verbose() > 4) { HashburstMiner::Log::print(HashburstMiner::Log::INFO, x, ##__VA_ARGS__); }

#ifdef APP_DEBUG
#   define LOG_DEBUG(x, ...) HashburstMiner::Log::print(HashburstMiner::Log::DEBUG, x, ##__VA_ARGS__)
#else
#   define LOG_DEBUG(x, ...)
#endif

#if defined(APP_DEBUG) || defined(APP_DEVEL)
#   define LOG_DEBUG_ERR(x, ...)  HashburstMiner::Log::print(HashburstMiner::Log::ERR,     x, ##__VA_ARGS__)
#   define LOG_DEBUG_WARN(x, ...) HashburstMiner::Log::print(HashburstMiner::Log::WARNING, x, ##__VA_ARGS__)
#else
