...
// since 2019.05.16, Version 1.29.0 (Stable) https://github.com/hashburst/HashburstMiner/HashburstMiner/pull/1889
...
HashburstMiner::Async::Async(Callback callback) : d_ptr(new AsyncPrivate())
{
...
HashburstMiner::Async::Async(IAsyncListener *listener) : d_ptr(new AsyncPrivate())
{
...
void HashburstMiner::Async::send()
{
