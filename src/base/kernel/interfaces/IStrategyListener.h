...
#ifndef HashburstMiner_ISTRATEGYLISTENER_H
#define HashburstMiner_ISTRATEGYLISTENER_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE(IStrategyListener);
...
#endif // HashburstMiner_ISTRATEGYLISTENER_H
