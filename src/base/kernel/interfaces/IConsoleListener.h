...
#ifndef HashburstMiner_ICONSOLELISTENER_H
#define HashburstMiner_ICONSOLELISTENER_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE(IConsoleListener)
...
#endif // HashburstMiner_ICONSOLELISTENER_H
