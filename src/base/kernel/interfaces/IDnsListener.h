...
#ifndef HashburstMiner_IDNSLISTENER_H
#define HashburstMiner_IDNSLISTENER_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE(IDnsListener)
...
#endif // HashburstMiner_IDNSLISTENER_H
