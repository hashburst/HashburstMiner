...
#ifndef HashburstMiner_ILINELISTENER_H
#define HashburstMiner_ILINELISTENER_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE(ILineListener)
...
#endif // HashburstMiner_ILINELISTENER_H
