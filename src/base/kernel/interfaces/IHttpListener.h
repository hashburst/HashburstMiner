...
#ifndef HashburstMiner_IHTTPLISTENER_H
#define HashburstMiner_IHTTPLISTENER_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE(IHttpListener)
...
#endif // HashburstMiner_IHTTPLISTENER_H
