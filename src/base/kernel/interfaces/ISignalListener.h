...
#ifndef HashburstMiner_ISIGNALLISTENER_H
#define HashburstMiner_ISIGNALLISTENER_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE(ISignalListener)
...
#endif // HashburstMiner_ISIGNALLISTENER_H
