...
#ifndef HashburstMiner_IASYNCLISTENER_H
#define HashburstMiner_IASYNCLISTENER_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE(IAsyncListener)
...
#endif // HashburstMiner_IASYNCLISTENER_H
