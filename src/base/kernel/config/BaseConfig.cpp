...
bool HashburstMiner::BaseConfig::read(const IJsonReader &reader, const char *fileName)
{
    m_fileName = fileName;
...
bool HashburstMiner::BaseConfig::save()
{
...
void HashburstMiner::BaseConfig::printVersions()
{
    char buf[256] = { 0 };
...
#   if defined(HashburstMiner_FEATURE_TLS)
    {
...
#   if defined(HashburstMiner_FEATURE_HWLOC)
...
void HashburstMiner::BaseConfig::setVerbose(const rapidjson::Value &value)
{
    if (value.IsBool()) {
