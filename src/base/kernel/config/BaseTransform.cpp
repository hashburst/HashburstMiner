...
void HashburstMiner::BaseTransform::load(JsonChain &chain, Process *process, IConfigTransform &transform)
{
...
void HashburstMiner::BaseTransform::finalize(rapidjson::Document &doc)
{
    using namespace rapidjson;
...
void HashburstMiner::BaseTransform::transform(rapidjson::Document &doc, int key, const char *arg)
{
    switch (key) {
...
#           ifdef HashburstMiner_FEATURE_TLS
                "stratum+ssl://randomx.HashburstMiner.com:443"
#           else
                "randomx.HashburstMiner.com:3333"
#           endif
            );
        } else
#       endif
...
void HashburstMiner::BaseTransform::transformBoolean(rapidjson::Document &doc, int key, bool enable)
{
    switch (key) {
    case IConfig::BackgroundKey: /* --background */
...
void HashburstMiner::BaseTransform::transformUint64(rapidjson::Document &doc, int key, uint64_t arg)
{
    switch (key) {
    case IConfig::RetriesKey: /* --retries */
