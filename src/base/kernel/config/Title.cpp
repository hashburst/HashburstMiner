...
HashburstMiner::Title::Title(const rapidjson::Value &value)
{
    if (value.IsBool()) {
...
rapidjson::Value HashburstMiner::Title::toJSON() const
{
...
HashburstMiner::String HashburstMiner::Title::value() const
{
    if (!isEnabled()) {
        return {};
    }
