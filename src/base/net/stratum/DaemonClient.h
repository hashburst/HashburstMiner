...
#ifndef HashburstMiner_DAEMONCLIENT_H
#define HashburstMiner_DAEMONCLIENT_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(DaemonClient)
...
#endif /* HashburstMiner_DAEMONCLIENT_H */
