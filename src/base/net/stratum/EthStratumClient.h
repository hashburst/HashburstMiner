...
#ifndef HashburstMiner_ETHSTRATUMCLIENT_H
#define HashburstMiner_ETHSTRATUMCLIENT_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(EthStratumClient)
...
#endif /* HashburstMiner_ETHSTRATUMCLIENT_H */
