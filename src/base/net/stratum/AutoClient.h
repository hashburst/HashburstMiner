...
#ifndef HashburstMiner_AUTOCLIENT_H
#define HashburstMiner_AUTOCLIENT_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(AutoClient)
...
#endif /* HashburstMiner_AUTOCLIENT_H */
