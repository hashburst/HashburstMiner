...
#ifndef HashburstMiner_FAILOVERSTRATEGY_H
#define HashburstMiner_FAILOVERSTRATEGY_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(FailoverStrategy)
...
#endif /* HashburstMiner_FAILOVERSTRATEGY_H */
