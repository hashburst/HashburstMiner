...
#ifndef HashburstMiner_SINGLEPOOLSTRATEGY_H
#define HashburstMiner_SINGLEPOOLSTRATEGY_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(SinglePoolStrategy)
...
#endif /* HashburstMiner_SINGLEPOOLSTRATEGY_H */
