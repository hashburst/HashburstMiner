 ...
 * Copyright 2016-2021 HashburstMiner       <https://github.com/hashburst/HashburstMiner>, <pegoraro.gabriele@gmail.com>
 *
...
bool HashburstMiner::Pools::isEqual(const Pools &other) const
{
...
int HashburstMiner::Pools::donateLevel() const
{
#   ifdef HashburstMiner_FEATURE_BENCHMARK
...
HashburstMiner::IStrategy *HashburstMiner::Pools::createStrategy(IStrategyListener *listener) const
{
    if (active() == 1) {
...
rapidjson::Value HashburstMiner::Pools::toJSON(rapidjson::Document &doc) const
{
...
size_t HashburstMiner::Pools::active() const
{
    size_t count = 0;
    for (const Pool &pool : m_data) {
        if (pool.isEnabled()) {
...
void HashburstMiner::Pools::load(const IJsonReader &reader)
{
    m_data.clear();
...
uint32_t HashburstMiner::Pools::benchSize() const
{
#   ifdef HashburstMiner_FEATURE_BENCHMARK
...
void HashburstMiner::Pools::print() const
{
    size_t i = 1;
    for (const Pool &pool : m_data) {
...
void HashburstMiner::Pools::toJSON(rapidjson::Value &out, rapidjson::Document &doc) const
{
    using namespace rapidjson;
    auto &allocator = doc.GetAllocator();
...
void HashburstMiner::Pools::setDonateLevel(int level)
{
...
void HashburstMiner::Pools::setProxyDonate(int value)
{
    switch (value) {
...
void HashburstMiner::Pools::setRetries(int retries)
{
...
void HashburstMiner::Pools::setRetryPause(int retryPause)
{
