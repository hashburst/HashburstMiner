...
HashburstMiner::ProxyUrl::ProxyUrl(const rapidjson::Value &value)
{
    m_port = 0;
...
const HashburstMiner::String &HashburstMiner::ProxyUrl::host() const
{
    return m_host.isNull() && isValid() ? kLocalhost : m_host;
}


rapidjson::Value HashburstMiner::ProxyUrl::toJSON(rapidjson::Document &doc) const
{
