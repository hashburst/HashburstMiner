...
HashburstMiner::EthStratumClient::EthStratumClient(int id, const char *agent, IClientListener *listener) :
    Client(id, agent, listener)
{
}


int64_t HashburstMiner::EthStratumClient::submit(const JobResult& result)
{
...
void HashburstMiner::EthStratumClient::login()
{
    m_results.clear();
...
void HashburstMiner::EthStratumClient::onClose()
{
    m_authorized = false;
    Client::onClose();
}
...
bool HashburstMiner::EthStratumClient::handleResponse(int64_t id, const rapidjson::Value &result, const rapidjson::Value &error)
{
...
void HashburstMiner::EthStratumClient::parseNotification(const char *method, const rapidjson::Value &params, const rapidjson::Value &)
{
...
void HashburstMiner::EthStratumClient::setExtraNonce(const rapidjson::Value &nonce)
{
    if (!nonce.IsString()) {
...
const char *HashburstMiner::EthStratumClient::errorMessage(const rapidjson::Value &error)
{
...
void HashburstMiner::EthStratumClient::authorize()
{
    using namespace rapidjson;
...
void HashburstMiner::EthStratumClient::onAuthorizeResponse(const rapidjson::Value &result, bool success, uint64_t)
{
    try {
        if (!success) {
...
void HashburstMiner::EthStratumClient::onSubscribeResponse(const rapidjson::Value &result, bool success, uint64_t)
{
    if (!success) {
        return;
    }
...
void HashburstMiner::EthStratumClient::subscribe()
{
    using namespace rapidjson;
