...
#ifndef HashburstMiner_BENCHCLIENT_H
#define HashburstMiner_BENCHCLIENT_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(BenchClient)
...
#endif /* HashburstMiner_BENCHCLIENT_H */
