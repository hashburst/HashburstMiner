...
#ifndef HashburstMiner_DEBUG_BENCHMARK_API
const char *BenchConfig::kApiHost   = "api.HashburstMiner.com";
#else
...
HashburstMiner::BenchConfig::BenchConfig(uint32_t size, const String &id, const rapidjson::Value &object, bool dmi, uint32_t rotation) :
...
HashburstMiner::BenchConfig *HashburstMiner::BenchConfig::create(const rapidjson::Value &object, bool dmi)
{
...
rapidjson::Value HashburstMiner::BenchConfig::toJSON(rapidjson::Document &doc) const
{
...
uint32_t HashburstMiner::BenchConfig::getSize(const char *benchmark)
{
    if (!benchmark) {
        return 0;
    }
