...
#ifndef HashburstMiner_SELFSELECTCLIENT_H
#define HashburstMiner_SELFSELECTCLIENT_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(SelfSelectClient)
...
#endif /* HashburstMiner_SELFSELECTCLIENT_H */
