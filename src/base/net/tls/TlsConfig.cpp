 ...
 */
HashburstMiner::TlsConfig::TlsConfig(const rapidjson::Value &value)
{
    if (value.IsObject()) {
...
#   ifdef HashburstMiner_FORCE_TLS
...
bool HashburstMiner::TlsConfig::generate(const char *commonName)
{
    TlsGen gen;
...
rapidjson::Value HashburstMiner::TlsConfig::toJSON(rapidjson::Document &doc) const
{
...
void HashburstMiner::TlsConfig::setProtocols(const char *protocols)
{
...
void HashburstMiner::TlsConfig::setProtocols(const rapidjson::Value &protocols)
{
    m_protocols = 0;
