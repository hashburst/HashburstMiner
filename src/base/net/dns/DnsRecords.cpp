...
const HashburstMiner::DnsRecord &HashburstMiner::DnsRecords::get(DnsRecord::Type prefered) const
{
...
size_t HashburstMiner::DnsRecords::count(DnsRecord::Type type) const
{
    if (type == DnsRecord::A) {
        return m_ipv4.size();
    }
...
void HashburstMiner::DnsRecords::clear()
{
    m_ipv4.clear();
    m_ipv6.clear();
}
...
void HashburstMiner::DnsRecords::parse(addrinfo *res)
{
    clear();
