...
#ifndef HashburstMiner_DNSUVBACKEND_H
#define HashburstMiner_DNSUVBACKEND_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE(DnsUvBackend)
...
#endif /* HashburstMiner_DNSUVBACKEND_H */
