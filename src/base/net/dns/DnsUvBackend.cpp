...
HashburstMiner::DnsUvBackend::DnsUvBackend()
{
...
std::shared_ptr<HashburstMiner::DnsRequest> HashburstMiner::DnsUvBackend::resolve(const String &host, IDnsListener *listener, uint64_t ttl)
{
...
bool HashburstMiner::DnsUvBackend::resolve(const String &host)
{
...
void HashburstMiner::DnsUvBackend::done()
{
...
void HashburstMiner::DnsUvBackend::onResolved(int status, addrinfo *res)
{
...
void HashburstMiner::DnsUvBackend::onResolved(uv_getaddrinfo_t *req, int status, addrinfo *res)
{
