...
HashburstMiner::DnsRecord::DnsRecord(const addrinfo *addr) :
...
const sockaddr *HashburstMiner::DnsRecord::addr(uint16_t port) const
{
...
HashburstMiner::String HashburstMiner::DnsRecord::ip() const
{
    char *buf = nullptr;
