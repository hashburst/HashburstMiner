...
#ifndef HashburstMiner_DNSREQUEST_H
#define HashburstMiner_DNSREQUEST_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(DnsRequest)
...
#endif /* HashburstMiner_DNSREQUEST_H */
