...
#ifndef HashburstMiner_HTTPSCONTEXT_H
#define HashburstMiner_HTTPSCONTEXT_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(HttpsContext)
...
#endif // HashburstMiner_HTTPSCONTEXT_H
