...
#ifndef HashburstMiner_HTTPSSERVER_H
#define HashburstMiner_HTTPSSERVER_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(HttpsServer)
...
#endif // HashburstMiner_HTTPSSERVER_H
