...
#ifndef HashburstMiner_HTTPSCLIENT_H
#define HashburstMiner_HTTPSCLIENT_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(HttpsClient)
...
#endif // HashburstMiner_HTTPSCLIENT_H
