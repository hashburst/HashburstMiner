...
#ifndef HashburstMiner_HTTPSERVER_H
#define HashburstMiner_HTTPSERVER_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(HttpServer)
...
#endif // HashburstMiner_HTTPSERVER_H
