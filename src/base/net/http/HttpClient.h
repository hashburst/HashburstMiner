...
#ifndef HashburstMiner_HTTPCLIENT_H
#define HashburstMiner_HTTPCLIENT_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(HttpClient);
...
#endif // HashburstMiner_HTTPCLIENT_H
