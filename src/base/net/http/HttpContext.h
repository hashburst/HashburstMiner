...
#ifndef HashburstMiner_HTTPCONTEXT_H
#define HashburstMiner_HTTPCONTEXT_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(HttpContext)
...
#endif // HashburstMiner_HTTPCONTEXT_H
