if (BUILD_STATIC AND HashburstMiner_OS_UNIX AND WITH_OPENCL)
...
if (WITH_OPENCL)
    add_definitions(/DHashburstMiner_FEATURE_OPENCL)
    add_definitions(/DCL_USE_DEPRECATED_OPENCL_1_2_APIS)
    if (HashburstMiner_OS_APPLE)
    ...
    if (WITH_STRICT_CACHE)
        add_definitions(/DHashburstMiner_STRICT_OPENCL_CACHE)
    else()
        remove_definitions(/DHashburstMiner_STRICT_OPENCL_CACHE)
    endif()

    if (WITH_INTERLEAVE_DEBUG_LOG)
        add_definitions(/DHashburstMiner_INTERLEAVE_DEBUG)
    endif()

    if (WITH_ADL AND (HashburstMiner_OS_WIN OR HashburstMiner_OS_LINUX))
        add_definitions(/DHashburstMiner_FEATURE_ADL)
       ...
       remove_definitions(/DHashburstMiner_FEATURE_ADL)
    endif()
else()
    remove_definitions(/DHashburstMiner_FEATURE_OPENCL)
    remove_definitions(/DHashburstMiner_FEATURE_ADL)
