...
#ifndef HashburstMiner_BLAKE2BINITIALHASHBIGKERNEL_H
#define HashburstMiner_BLAKE2BINITIALHASHBIGKERNEL_H
...
#endif /* HashburstMiner_BLAKE2BINITIALHASHBIGKERNEL_H */
