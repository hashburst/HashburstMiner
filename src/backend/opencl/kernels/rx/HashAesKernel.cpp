...
void HashburstMiner::HashAesKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void HashburstMiner::HashAesKernel::setArgs(cl_mem input, cl_mem hash, uint32_t hashStrideBytes, uint32_t batch_size)
{
