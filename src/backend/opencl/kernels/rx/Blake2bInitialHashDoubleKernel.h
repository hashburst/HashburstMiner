...
#ifndef HashburstMiner_BLAKE2BINITIALHASHDOUBLEKERNEL_H
#define HashburstMiner_BLAKE2BINITIALHASHDOUBLEKERNEL_H
...
#endif /* HashburstMiner_BLAKE2BINITIALHASHDOUBLEKERNEL_H */
