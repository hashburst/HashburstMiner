...
void HashburstMiner::Blake2bInitialHashDoubleKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void HashburstMiner::Blake2bInitialHashDoubleKernel::setArgs(cl_mem out, cl_mem blockTemplate)
{
...
void HashburstMiner::Blake2bInitialHashDoubleKernel::setBlobSize(size_t size)
{
...
void HashburstMiner::Blake2bInitialHashDoubleKernel::setNonce(uint32_t nonce)
{
