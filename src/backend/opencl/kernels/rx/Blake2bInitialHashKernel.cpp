...
void HashburstMiner::Blake2bInitialHashKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void HashburstMiner::Blake2bInitialHashKernel::setArgs(cl_mem out, cl_mem blockTemplate)
{
...
void HashburstMiner::Blake2bInitialHashKernel::setBlobSize(size_t size)
{
...
void HashburstMiner::Blake2bInitialHashKernel::setNonce(uint32_t nonce)
{
