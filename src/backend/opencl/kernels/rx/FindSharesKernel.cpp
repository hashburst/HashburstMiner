...
void HashburstMiner::FindSharesKernel::enqueue(cl_command_queue queue, size_t threads)
{
...
void HashburstMiner::FindSharesKernel::setArgs(cl_mem hashes, cl_mem shares)
{
...
void HashburstMiner::FindSharesKernel::setTarget(uint64_t target)
{
    setArg(1, sizeof(uint64_t), &target);
}


void HashburstMiner::FindSharesKernel::setNonce(uint32_t nonce)
{
