...
HashburstMiner::OclContext::OclContext(const OclDevice &device)
{
...
HashburstMiner::OclContext::~OclContext()
{
    if (m_ctx) {
...
bool HashburstMiner::OclContext::init(const std::vector<OclDevice> &devices, std::vector<OclLaunchData> &threads)
{
    if (!m_ctx) {
