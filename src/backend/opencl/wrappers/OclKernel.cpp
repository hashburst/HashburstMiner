...
HashburstMiner::OclKernel::OclKernel(cl_program program, const char *name) :
    m_name(name)
{
...
HashburstMiner::OclKernel::~OclKernel()
{
    OclLib::release(m_kernel);
}


void HashburstMiner::OclKernel::enqueueNDRange(cl_command_queue queue, uint32_t work_dim, const size_t *global_work_offset, const size_t *global_work_size, const size_t *local_work_size)
{
...
void HashburstMiner::OclKernel::setArg(uint32_t index, size_t size, const void *value)
{
