...
std::vector<HashburstMiner::OclPlatform> HashburstMiner::OclPlatform::get()
{
...
void HashburstMiner::OclPlatform::print()
{
...
rapidjson::Value HashburstMiner::OclPlatform::toJSON(rapidjson::Document &doc) const
{
...
std::vector<HashburstMiner::OclDevice> HashburstMiner::OclPlatform::devices() const
{
...
HashburstMiner::String HashburstMiner::OclPlatform::extensions() const
{
    return OclLib::getString(id(), CL_PLATFORM_EXTENSIONS);
}


HashburstMiner::String HashburstMiner::OclPlatform::name() const
{
    return OclLib::getString(id(), CL_PLATFORM_NAME);
}


HashburstMiner::String HashburstMiner::OclPlatform::profile() const
{
    return OclLib::getString(id(), CL_PLATFORM_PROFILE);
}


HashburstMiner::String HashburstMiner::OclPlatform::vendor() const
{
    return OclLib::getString(id(), CL_PLATFORM_VENDOR);
}


HashburstMiner::String HashburstMiner::OclPlatform::version() const
{
