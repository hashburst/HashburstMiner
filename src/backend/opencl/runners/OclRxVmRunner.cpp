...
HashburstMiner::OclRxVmRunner::OclRxVmRunner(size_t index, const OclLaunchData &data) : OclRxBaseRunner(index, data)
{
}


HashburstMiner::OclRxVmRunner::~OclRxVmRunner()
{
    delete m_init_vm;
    delete m_execute_vm;
...
size_t HashburstMiner::OclRxVmRunner::bufferSize() const
{
    return OclRxBaseRunner::bufferSize() + (align(2560 * m_intensity));
}


void HashburstMiner::OclRxVmRunner::build()
{
...
void HashburstMiner::OclRxVmRunner::execute(uint32_t iteration)
{
...
void HashburstMiner::OclRxVmRunner::init()
{
