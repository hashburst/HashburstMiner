...
#ifndef HashburstMiner_OCLBASERUNNER_H
#define HashburstMiner_OCLBASERUNNER_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(OclBaseRunner)
...
#endif // HashburstMiner_OCLBASERUNNER_H
