...
#ifndef HashburstMiner_OCLRXJITRUNNER_H
#define HashburstMiner_OCLRXJITRUNNER_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(OclRxJitRunner)
...
#endif // HashburstMiner_OCLRXRUNNER_H
