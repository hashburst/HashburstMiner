...
HashburstMiner::OclCnRunner::OclCnRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
HashburstMiner::OclCnRunner::~OclCnRunner()
{
    delete m_cn0;
    delete m_cn1;
    delete m_cn2;
...
size_t HashburstMiner::OclCnRunner::bufferSize() const
{
...
void HashburstMiner::OclCnRunner::run(uint32_t nonce, uint32_t /*nonce_offset*/, uint32_t *hashOutput)
{
...
void HashburstMiner::OclCnRunner::set(const Job &job, uint8_t *blob)
{
...
void HashburstMiner::OclCnRunner::build()
{
    OclBaseRunner::build();
...
void HashburstMiner::OclCnRunner::init()
{
    OclBaseRunner::init();
