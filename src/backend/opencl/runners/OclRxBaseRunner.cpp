...
HashburstMiner::OclRxBaseRunner::OclRxBaseRunner(size_t index, const OclLaunchData &data) : OclBaseRunner(index, data)
{
...
HashburstMiner::OclRxBaseRunner::~OclRxBaseRunner()
{
...
void HashburstMiner::OclRxBaseRunner::run(uint32_t nonce, uint32_t nonce_offset, uint32_t *hashOutput)
{
...
void HashburstMiner::OclRxBaseRunner::set(const Job &job, uint8_t *blob)
{
...
size_t HashburstMiner::OclRxBaseRunner::bufferSize() const
{
...
void HashburstMiner::OclRxBaseRunner::build()
{
    OclBaseRunner::build();
...
void HashburstMiner::OclRxBaseRunner::init()
{
    OclBaseRunner::init();
