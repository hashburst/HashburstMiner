...
#ifndef HashburstMiner_OCLRXBASERUNNER_H
#define HashburstMiner_OCLRXBASERUNNER_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(OclRxBaseRunner)
...
#endif // HashburstMiner_OCLRXBASERUNNER_H
