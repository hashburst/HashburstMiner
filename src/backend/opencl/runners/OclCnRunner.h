...
#ifndef HashburstMiner_OCLCNRUNNER_H
#define HashburstMiner_OCLCNRUNNER_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(OclCnRunner)
...
#endif // HashburstMiner_OCLCNRUNNER_H
