...
HashburstMiner::OclRxJitRunner::OclRxJitRunner(size_t index, const OclLaunchData &data) : OclRxBaseRunner(index, data)
{
}


HashburstMiner::OclRxJitRunner::~OclRxJitRunner()
{
...
void HashburstMiner::OclRxJitRunner::execute(uint32_t iteration)
{
...
void HashburstMiner::OclRxJitRunner::init()
{
...
bool HashburstMiner::OclRxJitRunner::loadAsmProgram()
{
