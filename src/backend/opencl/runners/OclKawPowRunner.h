...
#ifndef HashburstMiner_OCLKAWPOWRUNNER_H
#define HashburstMiner_OCLKAWPOWRUNNER_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(OclKawPowRunner)
...
#endif // HashburstMiner_OCLKAWPOWRUNNER_H
