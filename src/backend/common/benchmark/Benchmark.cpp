...
HashburstMiner::Benchmark::Benchmark(size_t workers, const IBackend *backend) :
    m_backend(backend),
    m_workers(workers)
{
}
...
bool HashburstMiner::Benchmark::finish(uint64_t totalHashCount)
{
...
void HashburstMiner::Benchmark::start()
{
    m_startTime = BenchState::start(m_workers, m_backend);
}


void HashburstMiner::Benchmark::printProgress() const
{
