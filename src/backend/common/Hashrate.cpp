...
HashburstMiner::Hashrate::Hashrate(size_t threads) :
    m_threads(threads + 1)
{
...
HashburstMiner::Hashrate::~Hashrate()
{
    for (size_t i = 0; i < m_threads; i++) {
        delete [] m_counts[i];
...
double HashburstMiner::Hashrate::average() const
{
...
const char *HashburstMiner::Hashrate::format(double h, char *buf, size_t size)
{
    return ::format(h, buf, size);
}


rapidjson::Value HashburstMiner::Hashrate::normalize(double d)
{
...
rapidjson::Value HashburstMiner::Hashrate::toJSON(rapidjson::Document &doc) const
{
...
rapidjson::Value HashburstMiner::Hashrate::toJSON(size_t threadId, rapidjson::Document &doc) const
{
    using namespace rapidjson;
    auto &allocator = doc.GetAllocator();
...
double HashburstMiner::Hashrate::hashrate(size_t index, size_t ms) const
{
    ...
    const uint64_t timeStampLimit = HashburstMiner::Chrono::steadyMSecs() - ms;
...
void HashburstMiner::Hashrate::addData(size_t index, uint64_t count, uint64_t timestamp)
{
