...
template <class T>
const T &HashburstMiner::Threads<T>::get(const String &profileName) const
{
    static T empty;
...
template <class T>
size_t HashburstMiner::Threads<T>::read(const rapidjson::Value &value)
{
...
template <class T>
HashburstMiner::String HashburstMiner::Threads<T>::profileName(const Algorithm &algorithm, bool strict) const
{
...
template <class T>
void HashburstMiner::Threads<T>::toJSON(rapidjson::Value &out, rapidjson::Document &doc) const
{
    using namespace rapidjson;
