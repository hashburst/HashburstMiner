...
#ifndef HashburstMiner_CPUBACKEND_H
#define HashburstMiner_CPUBACKEND_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(CpuBackend)
...
#endif /* HashburstMiner_CPUBACKEND_H */
