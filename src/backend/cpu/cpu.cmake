...
if (WITH_HWLOC)
    ...
    add_definitions(/DHashburstMiner_FEATURE_HWLOC)

    if (HWLOC_DEBUG)
        add_definitions(/DHashburstMiner_HWLOC_DEBUG)
    endif()
    ...
    remove_definitions(/DHashburstMiner_FEATURE_HWLOC)
