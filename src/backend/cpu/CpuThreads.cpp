...
HashburstMiner::CpuThreads::CpuThreads(const rapidjson::Value &value)
{
    if (value.IsArray()) {
...
HashburstMiner::CpuThreads::CpuThreads(size_t count, uint32_t intensity)
{
...
bool HashburstMiner::CpuThreads::isEqual(const CpuThreads &other) const
{
...
rapidjson::Value HashburstMiner::CpuThreads::toJSON(rapidjson::Document &doc) const
{
