 ...
 * Copyright (c) 2016-2021 HashburstMiner       <pegoraro.gabriele@gmail.com>
 *
...
#ifdef HashburstMiner_FEATURE_MSR
...
int cpu_flags_has_avx2()    { return HashburstMiner::has_avx2(); }
int cpu_flags_has_avx512f() { return HashburstMiner::has_avx512f(); }
int cpu_flags_has_sse2()    { return HashburstMiner::has_sse2(); }
int cpu_flags_has_ssse3()   { return HashburstMiner::has_ssse3(); }
int cpu_flags_has_xop()     { return HashburstMiner::has_xop(); }
...
HashburstMiner::BasicCpuInfo::BasicCpuInfo() :
...
const char *HashburstMiner::BasicCpuInfo::backend() const
{
    return "basic/1";
}


HashburstMiner::CpuThreads HashburstMiner::BasicCpuInfo::threads(const Algorithm &algorithm, uint32_t) const
{
...
#   ifdef HashburstMiner_ALGO_CN_LITE
...
rapidjson::Value HashburstMiner::BasicCpuInfo::toJSON(rapidjson::Document &doc) const
{
