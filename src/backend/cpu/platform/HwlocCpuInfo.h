...
#ifndef HashburstMiner_HWLOCCPUINFO_H
#define HashburstMiner_HWLOCCPUINFO_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE(HwlocCpuInfo)
...
#endif // HashburstMiner_HWLOCCPUINFO_H
