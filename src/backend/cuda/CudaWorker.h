...
#ifndef HashburstMiner_CUDAWORKER_H
#define HashburstMiner_CUDAWORKER_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(CudaWorker)
...
#endif /* HashburstMiner_CUDAWORKER_H */
