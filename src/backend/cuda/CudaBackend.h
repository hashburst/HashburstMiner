...
#ifndef HashburstMiner_CUDABACKEND_H
#define HashburstMiner_CUDABACKEND_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(CudaBackend)
...
#endif /* HashburstMiner_CUDABACKEND_H */
