...
rapidjson::Value HashburstMiner::CudaConfig::toJSON(rapidjson::Document &doc) const
{
...
std::vector<HashburstMiner::CudaLaunchData> HashburstMiner::CudaConfig::get(const Miner *miner, const Algorithm &algorithm, const std::vector<CudaDevice> &devices) const
{
...
void HashburstMiner::CudaConfig::read(const rapidjson::Value &value)
{
    if (value.IsObject()) {
...
void HashburstMiner::CudaConfig::generate()
{
    if (generated) {
        return;
    }
...
void HashburstMiner::CudaConfig::setDevicesHint(const char *devicesHint)
{
