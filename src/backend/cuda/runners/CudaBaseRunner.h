...
#ifndef HashburstMiner_CUDABASERUNNER_H
#define HashburstMiner_CUDABASERUNNER_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(CudaBaseRunner)
...
#endif // HashburstMiner_CUDABASERUNNER_H
