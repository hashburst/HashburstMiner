if (BUILD_STATIC AND HashburstMiner_OS_UNIX AND WITH_CUDA)
...
if (WITH_CUDA)
    add_definitions(/DHashburstMiner_FEATURE_CUDA)
   ...
   if (WITH_NVML AND NOT APPLE)
       add_definitions(/DHashburstMiner_FEATURE_NVML)
       ...
       remove_definitions(/DHashburstMiner_FEATURE_NVML)
   endif()
   ...
   if (WITH_KAWPOW)
    ...
    remove_definitions(/DHashburstMiner_FEATURE_CUDA)
    remove_definitions(/DHashburstMiner_FEATURE_NVML)
