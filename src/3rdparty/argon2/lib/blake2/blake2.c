...
void HashburstMiner_ar2_blake2b_init(blake2b_state *S, size_t outlen)
{
...
void HashburstMiner_ar2_blake2b_update(blake2b_state *S, const void *in, size_t inlen)
{
...
void HashburstMiner_ar2_blake2b_final(blake2b_state *S, void *out, size_t outlen)
{
    ...
    HashburstMiner_ar2_clear_internal_memory(buffer, sizeof(buffer));
    HashburstMiner_ar2_clear_internal_memory(S->buf, sizeof(S->buf));
    HashburstMiner_ar2_clear_internal_memory(S->h, sizeof(S->h));
}

void HashburstMiner_ar2_blake2b_long(void *out, size_t outlen, const void *in, size_t inlen)
{
    ...
    if (outlen <= BLAKE2B_OUTBYTES) {
        HashburstMiner_ar2_blake2b_init(&blake_state, outlen);
        HashburstMiner_ar2_blake2b_update(&blake_state, outlen_bytes, sizeof(outlen_bytes));
        HashburstMiner_ar2_blake2b_update(&blake_state, in, inlen);
        HashburstMiner_ar2_blake2b_final(&blake_state, pout, outlen);
    } else {
        uint32_t toproduce;
        uint8_t out_buffer[BLAKE2B_OUTBYTES];

        HashburstMiner_ar2_blake2b_init(&blake_state, BLAKE2B_OUTBYTES);
        HashburstMiner_ar2_blake2b_update(&blake_state, outlen_bytes, sizeof(outlen_bytes));
        HashburstMiner_ar2_blake2b_update(&blake_state, in, inlen);
        HashburstMiner_ar2_blake2b_final(&blake_state, out_buffer, BLAKE2B_OUTBYTES);
        ...
        while (toproduce > BLAKE2B_OUTBYTES) {
            HashburstMiner_ar2_blake2b_init(&blake_state, BLAKE2B_OUTBYTES);
            HashburstMiner_ar2_blake2b_update(&blake_state, out_buffer, BLAKE2B_OUTBYTES);
            HashburstMiner_ar2_blake2b_final(&blake_state, out_buffer, BLAKE2B_OUTBYTES);
        ...
        HashburstMiner_ar2_blake2b_init(&blake_state, toproduce);
        HashburstMiner_ar2_blake2b_update(&blake_state, out_buffer, BLAKE2B_OUTBYTES);
        HashburstMiner_ar2_blake2b_final(&blake_state, out_buffer, toproduce);

        memcpy(pout, out_buffer, toproduce);

        HashburstMiner_ar2_clear_internal_memory(out_buffer, sizeof(out_buffer));
    }
}
