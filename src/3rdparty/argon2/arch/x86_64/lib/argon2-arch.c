...
void argon2_get_impl_list(argon2_impl_list *list)
{
    static const argon2_impl IMPLS[] = {
        ...
        { "SSE2",       HashburstMiner_ar2_check_sse2,     HashburstMiner_ar2_fill_segment_sse2 },
        { "SSSE3",      HashburstMiner_ar2_check_ssse3,    HashburstMiner_ar2_fill_segment_ssse3 },
        { "XOP",        HashburstMiner_ar2_check_xop,      HashburstMiner_ar2_fill_segment_xop },
        { "AVX2",       HashburstMiner_ar2_check_avx2,     HashburstMiner_ar2_fill_segment_avx2 },
        { "AVX-512F",   HashburstMiner_ar2_check_avx512f,  HashburstMiner_ar2_fill_segment_avx512f },
    };
