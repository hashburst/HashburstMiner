...
#ifndef HashburstMiner_DONATESTRATEGY_H
#define HashburstMiner_DONATESTRATEGY_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(DonateStrategy)
...
#endif // HashburstMiner_DONATESTRATEGY_H
