...
HashburstMiner::Network::Network(Controller *controller) :
...
HashburstMiner::Network::~Network()
{
    JobResults::stop();
...
void HashburstMiner::Network::connect()
{
    m_strategy->connect();
}


void HashburstMiner::Network::execCommand(char command)
{
    switch (command) {
    case 's':
    case 'S':
...
void HashburstMiner::Network::onActive(IStrategy *strategy, IClient *client)
{
...
void HashburstMiner::Network::onConfigChanged(Config *config, Config *previousConfig)
{
...
void HashburstMiner::Network::onJob(IStrategy *strategy, IClient *client, const Job &job, const rapidjson::Value &)
{
...
void HashburstMiner::Network::onJobResult(const JobResult &result)
{
...
void HashburstMiner::Network::onLogin(IStrategy *, IClient *client, rapidjson::Document &doc, rapidjson::Value &params)
{
...
void HashburstMiner::Network::onPause(IStrategy *strategy)
{
    if (m_donate && m_donate == strategy) {
...
void HashburstMiner::Network::onResultAccepted(IStrategy *, IClient *, const SubmitResult &result, const char *error)
{
...
void HashburstMiner::Network::onVerifyAlgorithm(IStrategy *, const IClient *, const Algorithm &algorithm, bool *ok)
{
...
#ifdef HashburstMiner_FEATURE_API
void HashburstMiner::Network::onRequest(IApiRequest &request)
{
...
void HashburstMiner::Network::setJob(IClient *client, const Job &job, bool donate)
{
#   ifdef HashburstMiner_FEATURE_BENCHMARK
    if (!BenchState::size())
#   endif
...
void HashburstMiner::Network::tick()
{
...
#ifdef HashburstMiner_FEATURE_API
void HashburstMiner::Network::getConnection(rapidjson::Value &reply, rapidjson::Document &doc, int version) const
{
    using namespace rapidjson;
    auto &allocator = doc.GetAllocator();
...
void HashburstMiner::Network::getResults(rapidjson::Value &reply, rapidjson::Document &doc, int version) const
{
    using namespace rapidjson;
    auto &allocator = doc.GetAllocator();
