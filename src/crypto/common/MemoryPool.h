...
#ifndef HashburstMiner_MEMORYPOOL_H
#define HashburstMiner_MEMORYPOOL_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(MemoryPool)
...
#endif /* HashburstMiner_MEMORYPOOL_H */
