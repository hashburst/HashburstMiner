...
#ifndef HashburstMiner_VIRTUALMEMORY_H
#define HashburstMiner_VIRTUALMEMORY_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(VirtualMemory)
...
#endif /* HashburstMiner_VIRTUALMEMORY_H */
