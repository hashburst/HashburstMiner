...
#ifdef HashburstMiner_OS_FREEBSD
...
#ifdef HashburstMiner_SECURE_JIT
...
#if defined(HashburstMiner_OS_LINUX) || (!defined(HashburstMiner_OS_APPLE) && !defined(HashburstMiner_OS_FREEBSD))
...
bool HashburstMiner::VirtualMemory::isHugepagesAvailable()
{
#   ifdef HashburstMiner_OS_LINUX
...
#   elif defined(HashburstMiner_OS_MACOS) && defined(HashburstMiner_ARM)
    return false;
#   else
    return true;
#   endif
...
bool HashburstMiner::VirtualMemory::isOneGbPagesAvailable()
{
#   ifdef HashburstMiner_OS_LINUX
...
bool HashburstMiner::VirtualMemory::protectRW(void *p, size_t size)
{
#   if defined(HashburstMiner_OS_APPLE) && defined(HashburstMiner_ARM)
...
bool HashburstMiner::VirtualMemory::protectRWX(void *p, size_t size)
{
    return mprotect(p, size, PROT_READ | PROT_WRITE | PROT_EXEC) == 0;
}


bool HashburstMiner::VirtualMemory::protectRX(void *p, size_t size)
{
    bool result = true;
...
void *HashburstMiner::VirtualMemory::allocateExecutableMemory(size_t size, bool hugePages)
{
#   if defined(HashburstMiner_OS_APPLE)
...
void *HashburstMiner::VirtualMemory::allocateLargePagesMemory(size_t size)
{
#   if defined(HashburstMiner_OS_APPLE)
...
void *HashburstMiner::VirtualMemory::allocateOneGbPagesMemory(size_t size)
{
#   ifdef HashburstMiner_OS_LINUX
...
void HashburstMiner::VirtualMemory::flushInstructionCache(void *p, size_t size)
{
#   if defined(HashburstMiner_OS_APPLE)
...
void HashburstMiner::VirtualMemory::freeLargePagesMemory(void *p, size_t size)
{
    munmap(p, size);
}


void HashburstMiner::VirtualMemory::osInit(size_t hugePageSize)
{
    if (hugePageSize) {
...
bool HashburstMiner::VirtualMemory::allocateLargePagesMemory()
{
#   ifdef HashburstMiner_OS_LINUX
...
bool HashburstMiner::VirtualMemory::allocateOneGbPagesMemory()
{
#   ifdef HashburstMiner_OS_LINUX
...
void HashburstMiner::VirtualMemory::freeLargePagesMemory()
{
