...
bool HashburstMiner::LinuxMemory::reserve(size_t size, uint32_t node, size_t hugePageSize)
{
...
bool HashburstMiner::LinuxMemory::write(const char *path, uint64_t value)
{
...
int64_t HashburstMiner::LinuxMemory::read(const char *path)
{
