...
#ifndef HashburstMiner_MM_MALLOC_PORTABLE_H
#define HashburstMiner_MM_MALLOC_PORTABLE_H


#if defined(HashburstMiner_ARM) && !defined(__clang__)
#include <stdlib.h>
...
#endif /* HashburstMiner_MM_MALLOC_PORTABLE_H */
