...
HashburstMiner::Assembly::Id HashburstMiner::Assembly::parse(const char *assembly, Id defaultValue)
{
...
HashburstMiner::Assembly::Id HashburstMiner::Assembly::parse(const rapidjson::Value &value, Id defaultValue)
{
    if (value.IsBool()) {
...
const char *HashburstMiner::Assembly::toString() const
{
    return asmNames[m_id];
}


rapidjson::Value HashburstMiner::Assembly::toJSON() const
{
