...
#ifndef HashburstMiner_NUMAMEMORYPOOL_H
#define HashburstMiner_NUMAMEMORYPOOL_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(NUMAMemoryPool)
...
#endif /* HashburstMiner_NUMAMEMORYPOOL_H */
