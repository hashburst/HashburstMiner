...
HashburstMiner::Algorithm::Id HashburstMiner::RxAlgo::apply(Algorithm::Id algorithm)
{
...
const RandomX_ConfigurationBase *HashburstMiner::RxAlgo::base(Algorithm::Id algorithm)
{
    switch (algorithm) {
...
uint32_t HashburstMiner::RxAlgo::version(Algorithm::Id algorithm)
{
    return algorithm == Algorithm::RX_WOW ? 103 : 104;
}


uint32_t HashburstMiner::RxAlgo::programCount(Algorithm::Id algorithm)
{
    return base(algorithm)->ProgramCount;
}


uint32_t HashburstMiner::RxAlgo::programIterations(Algorithm::Id algorithm)
{
    return base(algorithm)->ProgramIterations;
}


uint32_t HashburstMiner::RxAlgo::programSize(Algorithm::Id algorithm)
{
