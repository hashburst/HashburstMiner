...
#ifndef HashburstMiner_RX_NUMASTORAGE_H
#define HashburstMiner_RX_NUMASTORAGE_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE(RxNUMAStorage);
...
#endif /* HashburstMiner_RX_NUMASTORAGE_H */
