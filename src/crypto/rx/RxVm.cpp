...
randomx_vm *HashburstMiner::RxVm::create(RxDataset *dataset, uint8_t *scratchpad, bool softAes, const Assembly &assembly, uint32_t node)
{
    int flags = 0;
...
void HashburstMiner::RxVm::destroy(randomx_vm* vm)
{
    if (vm) {
