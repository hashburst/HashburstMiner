...
#ifndef HashburstMiner_RX_DATASET_H
#define HashburstMiner_RX_DATASET_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(RxDataset)
...
#endif /* HashburstMiner_RX_DATASET_H */
