...
#ifndef HashburstMiner_PROFILER_H
#define HashburstMiner_PROFILER_H
...
#else /* HashburstMiner_FEATURE_PROFILING */
#define PROFILE_SCOPE(x)
#endif /* HashburstMiner_FEATURE_PROFILING */
...
#endif /* HashburstMiner_PROFILER_H */
