...
#ifndef HashburstMiner_RX_BASICSTORAGE_H
#define HashburstMiner_RX_BASICSTORAGE_H
...
{
public:
    HashburstMiner_DISABLE_COPY_MOVE(RxBasicStorage);
...
#endif /* HashburstMiner_RX_BASICSTORAGE_H */
