...
#ifndef HashburstMiner_ARGON2_HASH_H
#define HashburstMiner_ARGON2_HASH_H
...
namespace HashburstMiner { namespace argon2 {
...
}} // namespace HashburstMiner::argon2


#endif /* HashburstMiner_ARGON2_HASH_H */
