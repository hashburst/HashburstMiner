...
#ifndef HashburstMiner_CRYPTONIGHT_X86_H
#define HashburstMiner_CRYPTONIGHT_X86_H
...
void v4_soft_aes_compile_code(const V4_Instruction *code, int code_size, void *machine_code, HashburstMiner::Assembly ASM);
...
#   ifdef HashburstMiner_ALGO_CN_HEAVY
...
#           if defined(_MSC_VER) || (defined(__GNUC__) && (__GNUC__ == 8)) || !defined(HashburstMiner_64_BIT)
            d5 = d | 5;
#           else
...
void v4_compile_code(const V4_Instruction* code, int code_size, void* machine_code, HashburstMiner::Assembly ASM);
void v4_compile_code_double(const V4_Instruction* code, int code_size, void* machine_code, HashburstMiner::Assembly ASM);


template<HashburstMiner::Algorithm::Id ALGO>
void cn_r_compile_code(const V4_Instruction* code, int code_size, void* machine_code, HashburstMiner::Assembly ASM)
{
...
template<HashburstMiner::Algorithm::Id ALGO>
void cn_r_compile_code_double(const V4_Instruction* code, int code_size, void* machine_code, HashburstMiner::Assembly ASM)
{
...
#   ifdef HashburstMiner_ALGO_CN_PICO
...
#   ifdef HashburstMiner_ALGO_CN_FEMTO
...
#endif /* HashburstMiner_CRYPTONIGHT_X86_H */
