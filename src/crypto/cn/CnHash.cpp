...
static const HashburstMiner::CnHash cnHash;


HashburstMiner::CnHash::CnHash()
{
...
HashburstMiner::cn_hash_fun HashburstMiner::CnHash::fn(const Algorithm &algorithm, AlgoVariant av, Assembly::Id assembly)
{
