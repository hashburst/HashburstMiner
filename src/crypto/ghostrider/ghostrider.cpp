 ...
 * Copyright 2016-2023 HashburstMiner       <https://github.com/hashburst/HashburstMiner>, <pegoraro.gabriele@gmail.com>
 *
...
struct HelperThread
{
    HashburstMiner_DISABLE_COPY_MOVE_DEFAULT(HelperThread)
    ...
    struct TaskBase
    {
        HashburstMiner_DISABLE_COPY_MOVE(TaskBase)
...
#else // HashburstMiner_FEATURE_HWLOC
