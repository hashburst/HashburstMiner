...
HashburstMiner::Controller::Controller(Process *process) :
    Base(process)
{
}


HashburstMiner::Controller::~Controller()
{
    VirtualMemory::destroy();
}


int HashburstMiner::Controller::init()
{
    Base::init();
...
void HashburstMiner::Controller::start()
{
    Base::start();
...
void HashburstMiner::Controller::stop()
{
    Base::stop();
...
HashburstMiner::Miner *HashburstMiner::Controller::miner() const
{
    assert(m_miner);
...
HashburstMiner::Network *HashburstMiner::Controller::network() const
{
    assert(m_network);
...
void HashburstMiner::Controller::execCommand(char command) const
{
