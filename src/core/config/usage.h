...
#ifndef HashburstMiner_USAGE_H
#define HashburstMiner_USAGE_H
...
static inline const std::string &usage()
{
    ...
    u += "  -a, --algo=ALGO               mining algorithm https://HashburstMiner.com/docs/algorithms\n";
...
#   endif
    ...
    u += "      --donate-over-proxy=N     control donate over HashburstMiner-proxy feature\n";
...
#   ifdef HashburstMiner_FEATURE_CUDA
    ...
    u += "      --cuda-loader=PATH        path to CUDA plugin (HashburstMiner-cuda.dll or libHashburstMiner-cuda.so)\n";
