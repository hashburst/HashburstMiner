...
bool HashburstMiner::Config::isPauseOnBattery() const
{
    return d_ptr->pauseOnBattery;
}


const HashburstMiner::CpuConfig &HashburstMiner::Config::cpu() const
{
    return d_ptr->cpu;
}


uint32_t HashburstMiner::Config::idleTime() const
{
...
#ifdef HashburstMiner_FEATURE_OPENCL
const HashburstMiner::OclConfig &HashburstMiner::Config::cl() const
{
    return d_ptr->cl;
}
#endif
...
#ifdef HashburstMiner_FEATURE_CUDA
const HashburstMiner::CudaConfig &HashburstMiner::Config::cuda() const
{
    return d_ptr->cuda;
}
#endif
...
#ifdef HashburstMiner_ALGO_RANDOMX
const HashburstMiner::RxConfig &HashburstMiner::Config::rx() const
{
    return d_ptr->rx;
}
#endif
...
#if defined(HashburstMiner_FEATURE_NVML) || defined (HashburstMiner_FEATURE_ADL)
uint32_t HashburstMiner::Config::healthPrintTime() const
{
...
#ifdef HashburstMiner_FEATURE_DMI
bool HashburstMiner::Config::isDMI() const
{
    return d_ptr->dmi;
}
#endif
...
bool HashburstMiner::Config::isShouldSave() const
{
    if (!isAutoSave()) {
        return false;
    }
...
bool HashburstMiner::Config::read(const IJsonReader &reader, const char *fileName)
{
...
void HashburstMiner::Config::getJSON(rapidjson::Document &doc) const
{
