...
void HashburstMiner::ConfigTransform::finalize(rapidjson::Document &doc)
{
...
void HashburstMiner::ConfigTransform::transform(rapidjson::Document &doc, int key, const char *arg)
{
...
void HashburstMiner::ConfigTransform::transformBoolean(rapidjson::Document &doc, int key, bool enable)
{
    switch (key) {
    case IConfig::HugePagesKey: /* --no-huge-pages */
...
void HashburstMiner::ConfigTransform::transformUint64(rapidjson::Document &doc, int key, uint64_t arg)
{
    using namespace rapidjson;
...
#ifdef HashburstMiner_FEATURE_BENCHMARK
void HashburstMiner::ConfigTransform::transformBenchmark(rapidjson::Document &doc, int key, const char *arg)
{
    switch (key) {
    case IConfig::AlgorithmKey: /* --algo */
