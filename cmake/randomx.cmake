if (WITH_RANDOMX)
    add_definitions(/DHashburstMiner_ALGO_RANDOMX)
    set(WITH_ARGON2 ON)
    ...
    elseif (WITH_ASM AND NOT HashburstMiner_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND SOURCES_CRYPTO
    ...
    elseif (HashburstMiner_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8)
        list(APPEND SOURCES_CRYPTO
    ...
    if (WITH_MSR AND NOT HashburstMiner_ARM AND CMAKE_SIZEOF_VOID_P EQUAL 8 AND (HashburstMiner_OS_WIN OR HashburstMiner_OS_LINUX))
        add_definitions(/DHashburstMiner_FEATURE_MSR)
        add_definitions(/DHashburstMiner_FIX_RYZEN)
        message("-- WITH_MSR=ON")
        ...
        remove_definitions(/DHashburstMiner_FEATURE_MSR)
        remove_definitions(/DHashburstMiner_FIX_RYZEN)
        message("-- WITH_MSR=OFF")
    endif()

    if (WITH_PROFILING)
        add_definitions(/DHashburstMiner_FEATURE_PROFILING)

        list(APPEND HEADERS_CRYPTO src/crypto/rx/Profiler.h)
        list(APPEND SOURCES_CRYPTO src/crypto/rx/Profiler.cpp)
    endif()
else()
    remove_definitions(/DHashburstMiner_ALGO_RANDOMX)
endif()
